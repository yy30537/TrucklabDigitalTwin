...
namespace NWH.VehiclePhysics
{
    ...
    public class Downforce : MonoBehaviour
    {
        ...
        {
            /// <summary>
            /// environmentObjectPosition relative to the vehicleTransform at which downforce will be applied. Marked by red arrow gizmo.
            /// </summary>
            [Tooltip("environmentObjectPosition relative to the vehicleTransform at which downforce will be applied. Marked by red arrow gizmo.")]
