...
{
    /// <summary>
    /// Class for controlling all of the vehicleTransform lights.
    /// </summary>
    [System.Serializable]
    public class Lights
    {
        ...
        /// <summary>
        /// Rear Lights that will light up when vehicleTransform is in reverse gear(s). Usually white.
        /// </summary>
        [Tooltip("Rear Lights that will light up when vehicleTransform is traveling in reverse. Usually white.")]
        ...
        /// <summary>
        /// Blinkers on the left side of the vehicleTransform.
        /// </summary>
        [Tooltip("Blinkers on the left side of the vehicleTransform.")]
        public VehicleLight leftBlinkers = new VehicleLight();

        /// <summary>
        /// Blinkers on the right side of the vehicleTransform.
        /// </summary>
        [Tooltip("Blinkers on the right side of the vehicleTransform.")]
