...
namespace RosSharp.RosBridgeClient.MessageGeneration
{
    public class SingleSrvAutoGenEditorWindow : SingleAutoGenEditorWindow
    {
        ...
        [MenuItem("RosBridgeClient/Auto Generate Services/Single no...", false, 10)]
        public static void OpenWindow()
        {
            SingleSrvAutoGenEditorWindow window = GetWindow<SingleSrvAutoGenEditorWindow>(false, "no Auto Generation", true);
