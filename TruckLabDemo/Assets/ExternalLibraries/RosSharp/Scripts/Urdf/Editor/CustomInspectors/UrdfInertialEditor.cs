...
namespace RosSharp.Urdf.Editor
{
    ...
    public class UrdfInertialEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(pRigidbodyDataSource, new GUIContent("Rigidbody Scriptable Objects Source"));
            ...
            Vector3 angles = EditorGUILayout.Vector3Field("Inertia Tensor environmentObjectRotation", rigidbody.inertiaTensorRotation.eulerAngles);
