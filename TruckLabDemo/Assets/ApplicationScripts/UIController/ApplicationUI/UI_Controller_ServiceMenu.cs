...
namespace ApplicationScripts.UIController.ApplicationUI
{
    ...
    /// with dependent child controllers for vehicle creation and referencePath simulation.
    /// </summary>
    public class UI_Controller_ServiceMenu : Base_UI_Controller
    {
        ...
        /// <summary>
        /// Controller for managing the referencePath simulation UI.
        /// </summary>
        ...
        /// Ensures that only one dependent UI (vehicle creation or referencePath simulation) is visible at a Time.
        /// </summary>
        ...
        public override void Toggle_UI_Visibility(string target_ui_name)
        {
            ...
            // Hide the referencePath simulation UI if the vehicle creation UI is being toggled
            if (UiControllerVeCreator.UiName == target_ui_name)
            {
                UiControllerPathSimulation.HideUi();
            }

            // Hide the vehicle creation UI if the referencePath simulation UI is being toggled
