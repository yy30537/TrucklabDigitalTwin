...
namespace ApplicationScripts.VirtualEntity.Vehicle
{
    public class VE_Vehicle : VE
    {
        ...
        /// <param name="vehicle_creator">The vehicle creator responsible for managing vehicle instantiation.</param>
        /// <param name="space_creator">The space creator responsible for managing spaces in the simulation.</param>
