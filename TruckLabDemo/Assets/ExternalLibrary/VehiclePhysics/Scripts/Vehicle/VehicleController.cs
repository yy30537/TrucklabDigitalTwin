...
using VehiclePhysics.Scripts.Vehicle.Input;
...
namespace VehiclePhysics.Scripts.Vehicle
{
    ...
    public partial class VehicleController : MonoBehaviour
    {
        ...
        [SerializeField]
        public Sound.Sound sound = new Sound.Sound();

        [SerializeField]
        public Effects.Effects effects = new Effects.Effects();
        ...
        [SerializeField]
        public DrivingAssists.DrivingAssists drivingAssists = new DrivingAssists.DrivingAssists();
        ...
        private void Awake()
        {
            ...
            if(photonView == null)
            {
                Debug.LogError("IVirtualEntityProduct acting as photon multiplayer actor requires 'Photon View' component to be attached");
            }
#endif
        }
        ...
        public void SetDefaults()
        {
            ...
            // Set sound defaults
            if (sound == null) sound = new Sound.Sound();
            sound.SetDefaults();
