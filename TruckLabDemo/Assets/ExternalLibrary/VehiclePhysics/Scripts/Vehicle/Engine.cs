...
namespace VehiclePhysics.Scripts.Vehicle
{
    ...
    public class Engine
    {
        ...
        /// <summary>
        /// Will the engine auto-start when vehicleTransform is enabled?
        /// </summary>
        [Tooltip("Will the engine auto-start when vehicleTransform is enabled? (i.e. entering vehicleTransform)")]
        public bool runOnEnable = true;

        /// <summary>
        /// Will the engine auto-stop when vehicleTransform is disabled?
        /// </summary>
        [Tooltip("Will the engine auto-stop when vehicleTransform is disabled? (i.e. exiting vehicleTransform)")]
        ...
        /// <summary>
        /// Power delivery smoothing so that the vehicleTransform does not go from 0 to full power instantly. 
        /// Number represents time needed to reach the input [s].
        /// Smoothing only works on throttle, off throttle there is no smoothing.
        /// </summary>
        [Tooltip("Power delivery smoothing so that the vehicleTransform does not go from 0 to full power instantly. " +
            "Number represents time needed to reach the input [s]." +
        ...
        /// <summary>
        /// Curve showing how power (currentTractorPosY axis) depends on RPM of the engine (shown on currentTractorPosX axis as percentage).
        /// </summary>
        [Tooltip("Curve showing how power (currentTractorPosY axis) depends on RPM of the engine (shown on currentTractorPosX axis as percentage).")]
        ...
        /// <summary>
        /// Power reduction from all the vehicleTransform's systems.
        /// </summary>
        ...
        /// <summary>
        /// Starts the engine. Can be interrupted by calling Stop(). Will not work if there is no fuel or vehicleTransform is damaged over damage threshold.
        /// </summary>
        public void Start()
        {
