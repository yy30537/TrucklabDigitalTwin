...
namespace VehiclePhysics.Scripts.Vehicle.Effects
{
    ...
    public class ExhaustSmoke
    {
        ...
        /// <summary>
        /// Exhaust smoke intensity when vehicleTransform is idle.
        /// </summary>
        [Tooltip("Exhaust smoke intensity when vehicleTransform is idle.")]
        [Range(0, 30)]
        ...
        /// <summary>
        /// How far behind the vehicleTransform will exhaust particles extend?
        /// </summary>
        [Tooltip("How far behind the vehicleTransform will exhaust particles extend?")]
        [Range(0, 10)]
