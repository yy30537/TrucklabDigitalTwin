...
namespace VehiclePhysics.Scripts.Vehicle.Effects
{
    ...
    public class Skidmarks
    {
        ...
        /// <summary>
        /// If enabled skidmarks will stay on the ground until distance from the vehicleTransform becomes greater than persistentSkidmarkDistance.
        ...
        /// </summary>
        [Tooltip("If enabled skidmarks will stay on the ground until distance from the vehicleTransform becomes greater than persistentSkidmarkDistance. " +
        ...
        /// <summary>
        /// Persistent skidmarks get deleted when distance from the parent vehicleTransform is higher than this.
        /// </summary>
        [Tooltip("Persistent skidmarks get deleted when distance from the parent vehicleTransform is higher than this.")]
