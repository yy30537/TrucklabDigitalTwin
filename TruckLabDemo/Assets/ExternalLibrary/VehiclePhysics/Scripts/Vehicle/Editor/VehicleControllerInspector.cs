...
namespace VehiclePhysics.Scripts.Vehicle.Editor
{
    /// <summary>
    ...
    [ExecuteInEditMode]
    public class VehicleControllerInspector : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (logo != null)
            {
                ...
                UnityEngine.GUI.DrawTexture(new Rect(lastRect.x + width * 0.5f - logoWidth * 0.55f, lastRect.y + height * 0.5f - logoHeight * 0.4f, logoWidth, logoHeight), logo);
            }
        ...
        void GUIDrawRect(Rect position, Color color)
        {
            ...
            UnityEngine.GUI.Box(position, GUIContent.none, staticRectStyle);
