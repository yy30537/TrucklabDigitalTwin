...
namespace VehiclePhysics.Scripts.Vehicle
{
    ...
    {
        /// <summary>
        /// Should the vehicleTransform be rotated back when it flips over?
        /// </summary>
        [Tooltip("Should the vehicleTransform be rotated back when it flips over?")]
        ...
        /// <summary>
        /// Time after detecting flip over after which vehicleTransform will be flipped back.
        /// </summary>
        [Tooltip("Time after detecting flip over after which vehicleTransform will be flipped back or the manual button can be used.")]
        public float timeout = 3f;

        /// <summary>
        /// Minimum angle that the vehicleTransform needs to be at for it to be detected as flipped over.
        /// </summary>
        [Tooltip("Minimum angle that the vehicleTransform needs to be at for it to be detected as flipped over.")]
        ...
        /// <summary>
        /// environmentObjectRotation speed of the vehicleTransform while being flipped back.
        /// </summary>
        [Tooltip("environmentObjectRotation speed of the vehicleTransform while being flipped back.")]
        public float rotationSpeed = 80f;

        /// <summary>
        /// Is the vehicleTransform flipped over?
        /// </summary>
        [HideInInspector]
