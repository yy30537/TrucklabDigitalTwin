...
{
    /// <summary>
    /// Used for chaning VehicleConfigs. Also activates and deactivates vehicleTransform cameras if default VehicleCamera system is used.
    /// </summary>
    ...
    public class VehicleChanger : MonoBehaviour
    {
        ...
        /// <summary>
        /// Index of the current vehicleTransform in VehicleConfigs list.
        /// </summary>
        [Tooltip("Index of the current vehicleTransform. Set it to the vehicleTransform you want your scene to start with.")]
        private int currentIndex;

        /// <summary>
        /// Tag that the script will search for if VehicleConfigs list is empty. Can be left empty if VehicleConfigs have already been assigned manually.
        /// </summary>
        [Tooltip("Tag that the script will search for if VehicleConfigs list is empty. Can be left empty if VehicleConfigs have already been assigned manually.")]
        public string vehicleTag = "IVirtualEntityProduct";
        ...
        /// <summary>
        /// Finds nearest vehicleTransform on the VehicleConfigs list.
        /// </summary>
