...
namespace VehiclePhysics.Scripts.Wheel.Editor
{
    [CustomEditor(typeof(WheelController))]
    [CanEditMultipleObjects]
    public class WheelControllerInspector : UnityEditor.Editor
    {
        WheelController wc;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(rimOffset, new GUIContent("Rim Offset", "Side offset of the rim. Positive value will result in wheel further from the vehicleTransform."));

            GUILayout.Space(5);
            if (Application.isPlaying) UnityEngine.GUI.enabled = false;
            ...
            EditorGUILayout.HelpBox("currentTractorPosX: Spring compression [%], currentTractorPosY: Camber angle [deg]", MessageType.Info, true);
            ...
            EditorGUILayout.HelpBox("currentTractorPosX: Spring compression [%], currentTractorPosY: Force coefficient", MessageType.Info, true);
            ...
            EditorGUILayout.HelpBox("currentTractorPosX: Spring velocity [m/s], currentTractorPosY: Force coefficient", MessageType.Info, true);
            ...
            EditorGUILayout.HelpBox("currentTractorPosX: Slip, currentTractorPosY: Force coefficient", MessageType.Info, true);
