...
namespace VehiclePhysics.Scripts.Wheel
{
    [Serializable]
    public partial class WheelController : MonoBehaviour
    {
        ...
        /// <summary>
        /// Root object of the vehicleTransform.
        /// </summary>
        [SerializeField]
        ...
        /// <summary>
        /// Enables some wheel behaviors specific to tracked VehicleConfigs, specifically the fact that there is no wheel spin.
        /// </summary>
        [HideInInspector]
        public bool trackedVehicle = false;

        /// <summary>
        /// Only for tracked VehicleConfigs that use NVP wheel enlargement.
        ...
        /// Intended to be used with multiplayer for client VehicleConfigs.
        /// </summary>
        ...
        private void FrictionUpdate()
        {
            ...
            // No wheel spin for tracked VehicleConfigs
            if (trackedVehicle)
                wheel.angularVelocity = wheel.freeRollingAngularVelocity;
            ...
            // Limit side and forward force if needed, useful for drift VehicleConfigs in arcade games
        ...
        private void UpdateForces()
        {
            if (hasHit)
            {
                ...
                // Alternate normal cannot be used when on flat surface because of inaccuracies which cause vehicleTransform to creep forward or in reverse.
