...
namespace VehiclePhysics.Scripts.Wheel
{
    ...
    public partial class WheelController : MonoBehaviour
    {
        ...
        /// Returns false if vehicleTransform tipped over / tire sidewall is in contact.
        /// </summary>
        ...
        /// <summary>
        /// Side offset of the rim. Positive value will result if wheel further from the vehicleTransform. [meters]
        /// </summary>
        ...
        /// Negative angle means that the top of the wheel in closer to the vehicleTransform than the bottom.
        /// </summary>
        public float camber
        {
            get
        ...
        /// <summary>
        /// Returns vehicleTransform speed in meters per second [m/s], multiply by 3.6 for [kph] or by 2.24 for [mph].
        /// </summary>
        public float speed
        {
            get
