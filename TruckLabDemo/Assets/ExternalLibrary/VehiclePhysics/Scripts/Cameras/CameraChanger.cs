...
using UnityEngine;
using VehiclePhysics.Scripts.Vehicle;
...
namespace VehiclePhysics.Scripts.Cameras
{
    ...
    /// in order they appear in the hierarchy or in order they are added to the vehicleTransform cameras list.
    /// </summary>
    public class CameraChanger : MonoBehaviour
    {
        /// <summary>
        /// Index of the camera from vehicleTransform cameras list that will be active first.
        /// </summary>
        [Tooltip("Index of the camera from vehicleTransform cameras list that will be active first.")]
        public int currentCamera = 0;

        /// <summary>
        /// Cameras with this tag will be added to the vehicleTransform cameras list. Cameras need to be children of this object.
        /// </summary>
        [Tooltip("Cameras with this tag will be added to the vehicleTransform cameras list. Cameras need to be children of this object.")]
