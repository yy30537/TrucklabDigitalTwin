...
{
    /// <summary>
    /// Camera for on or in-vehicleTransform use with option of head movement according to the G-forces.
    /// </summary>
    public class CameraOnboard : MonoBehaviour
    {
        /// <summary>
        /// IVirtualEntityProduct Controller that this script is targeting. Can be left empty if head movement is not being used.
        /// </summary>
        [Tooltip("IVirtualEntityProduct Controller that this script is targeting. Can be left empty if head movement is not being used.")]
