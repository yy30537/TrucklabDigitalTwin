...
{
    /// <summary>
    /// Digital and analog gauge Controller. Can be used to create on-screen gauges or dash gauges inside VehicleConfigs.
    /// All of the gauges and lights are optional, e.g. only one gauge or light can be used.
    /// If you want to use this script with only one vehicleTransform do not assign vehicleTransform changer as the script will then use the current vehicleTransform from vehicleTransform changer.
