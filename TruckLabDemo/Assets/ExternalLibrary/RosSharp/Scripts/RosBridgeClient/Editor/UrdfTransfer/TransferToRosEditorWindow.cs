...
namespace RosSharp.Scripts.RosBridgeClient.Editor.UrdfTransfer
{
    ...
    {
        private static global::RosSharp.RosBridgeClient.Protocols.Protocol protocolType;
        ...
        private void OnGUI()
        {
            ...
            if (showSettings)
            {
                ...
                protocolType = (global::RosSharp.RosBridgeClient.Protocols.Protocol)EditorGUILayout.EnumPopup("Protocol", protocolType);
                EditorGUILayout.EndHorizontal();
        ...
        {
            protocolType = (global::RosSharp.RosBridgeClient.Protocols.Protocol)(EditorPrefs.HasKey("UrdfPublisherProtocolNumber") ?
