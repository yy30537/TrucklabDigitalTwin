...
namespace RosSharp.Scripts.RosBridgeClient.Editor.UrdfTransfer
{
    public class TransferFromRosHandler
    {
        ...
        public void TransferUrdf(global::RosSharp.RosBridgeClient.Protocols.Protocol protocolType, string serverUrl, int timeout, string assetPath, string urdfParameter, RosSocket.SerializerEnum serializer)
        {
        ...
        public void GenerateModelIfReady()
        {
            ...
            if (EditorUtility.DisplayDialog(
                ...
                "Yes", "No"))
            {
                global::RosSharp.Scripts.Urdf.Editor.UrdfComponents.UrdfRobotExtensions.Create(Path.Combine(
                    localDirectory,
