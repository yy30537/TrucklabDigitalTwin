...
namespace RosSharp.Scripts.RosBridgeClient.Editor.UrdfTransfer
{
    public class TransferToRosHandler
    {
        ...
        public void Transfer(global::RosSharp.RosBridgeClient.Protocols.Protocol protocolType, string serverUrl, int timeout, string urdfPath, string rosPackage, RosSocket.SerializerEnum serializer)
        {
        ...
        private void TransferAsync(global::RosSharp.RosBridgeClient.Protocols.Protocol protocolType, string serverUrl, int timeout, string urdfPath, string rosPackage, RosSocket.SerializerEnum serializer)
        {
