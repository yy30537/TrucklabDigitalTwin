...
namespace RosSharp.Scripts.RosBridgeClient.Timing
{
    public class Timer
    {
        public static DateTime UNIX_EPOCH = new DateTime(1970, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc);

        public virtual global::RosSharp.RosBridgeClient.MessageTypes.Std.Time Now()
        {
            Now(out uint secs, out uint nsecs);
            return new global::RosSharp.RosBridgeClient.MessageTypes.Std.Time(secs, nsecs);
        }

        public virtual void Now(global::RosSharp.RosBridgeClient.MessageTypes.Std.Time stamp)
        {
