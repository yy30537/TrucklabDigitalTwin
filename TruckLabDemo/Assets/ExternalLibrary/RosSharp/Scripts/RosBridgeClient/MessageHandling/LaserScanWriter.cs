...
using RosSharp.Scripts.RosBridgeClient.SensorDataVisualization;
using UnityEngine;
...
namespace RosSharp.Scripts.RosBridgeClient.MessageHandling
{
    public class LaserScanWriter : MonoBehaviour
    {
        ...
        public void Write(global::RosSharp.RosBridgeClient.MessageTypes.Sensor.LaserScan laserScan)
        {
