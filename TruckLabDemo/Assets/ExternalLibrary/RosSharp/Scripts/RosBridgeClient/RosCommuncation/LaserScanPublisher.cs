...
{
    public class LaserScanPublisher : UnityPublisher<LaserScan>
    {
        public LaserScanReader laserScanReader;
        public string FrameId = "Unity";

        private global::RosSharp.RosBridgeClient.MessageTypes.Sensor.LaserScan message;
        ...
        private void InitializeMessage()
        {
            ...
            message = new global::RosSharp.RosBridgeClient.MessageTypes.Sensor.LaserScan
            {
