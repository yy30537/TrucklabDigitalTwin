...
{
    public class JointStateSubscriber : UnitySubscriber<JointState>
    {
        public List<string> JointNames;
        public List<JointStateWriter> JointStateWriters;

        protected override void ReceiveMessage(global::RosSharp.RosBridgeClient.MessageTypes.Sensor.JointState message)
        {
            int index;
