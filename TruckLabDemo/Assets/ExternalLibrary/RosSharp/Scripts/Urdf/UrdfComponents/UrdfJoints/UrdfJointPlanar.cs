...
namespace RosSharp.Scripts.Urdf.UrdfComponents.UrdfJoints
{
    public class UrdfJointPlanar : UrdfJoint
    {
        ...
        {
            ConfigurableJoint joint = (ConfigurableJoint)UnityJoint;
            return !(System.Math.Abs(joint.axis.x) < Tolerance &&
                     System.Math.Abs(joint.axis.y) < Tolerance &&
                     System.Math.Abs(joint.axis.z) < Tolerance)
                   && !(System.Math.Abs(joint.secondaryAxis.x) < Tolerance &&
                        System.Math.Abs(joint.secondaryAxis.y) < Tolerance &&
                        System.Math.Abs(joint.secondaryAxis.z) < Tolerance);
        }
