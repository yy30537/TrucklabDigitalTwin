...
using RosSharp.Scripts.Urdf.Math;
using RosSharp.Urdf;
using UnityEngine;

namespace RosSharp.Scripts.Urdf.UrdfComponents
{
    ...
    public class UrdfInertial : MonoBehaviour
    {
        ...
        public Link.Inertial ExportInertialData()
        {
            ...
            return new Link.Inertial(System.Math.Round(_rigidbody.mass, RoundDigits), inertialOrigin, inertia);
        }
