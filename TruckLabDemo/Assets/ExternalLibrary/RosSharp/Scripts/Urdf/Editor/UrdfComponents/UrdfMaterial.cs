...
namespace RosSharp.Scripts.Urdf.Editor.UrdfComponents
{
    public static class UrdfMaterial
    {
        ...
        private static double[] ExportRgbaData(Material material)
        {
            return new double[]
            {
                System.Math.Round(material.color.r, RoundDigits),
                System.Math.Round(material.color.g, RoundDigits),
                System.Math.Round(material.color.b, RoundDigits),
                System.Math.Round(material.color.a, RoundDigits)
            };
        }
