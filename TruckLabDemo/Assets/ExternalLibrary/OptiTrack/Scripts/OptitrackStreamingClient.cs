...
using OptiTrack.Plugins.Managed.NatNetLib;
using UnityEngine;
    ...
    public class OptitrackStreamingClient : MonoBehaviour
    {
        ...
        private void OnNatNetFrameReceived( object sender, NatNetClient.NativeFrameReceivedEventArgs eventArgs )
        {
            ...
            try
            {
                ...
                NativeMethods.NatNet_DecodeTimecode(timecode, timecodeSubframe, out hour, out minute, out second, out frameNumber, out subframeNumber);
                ...
                for (int skelIdx = 0; skelIdx < frameSkeletonCount; ++skelIdx)
                {
                    ...
                    for (int boneIdx = 0; boneIdx < skelRbCount; ++boneIdx)
                    {
                        ...
                        // Flip coordinate handedness from right to left by inverting currentTractorPosX and W.
