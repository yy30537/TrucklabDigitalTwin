...
using Application_Scripts.Virtual_Entity.Space.Controllers;
...
namespace Application_Scripts.Virtual_Entity.Space
{
    public class VE_Space : VE
    {
        ...
        /// <param name="vehicle__creator">Reference to the vehicle creator.</param>
        ...
        private void CreateSpaceLabel()
        {
            ...
            Destroy(spaceLabel.GetComponent<MeshCollider>());
        }
