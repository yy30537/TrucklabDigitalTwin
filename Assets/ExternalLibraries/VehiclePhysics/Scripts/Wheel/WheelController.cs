...
namespace NWH.WheelController3D
{
    ...
    public partial class WheelController : MonoBehaviour
    {
        ...
        /// <summary>
        /// Enables some wheel behaviors specific to tracked vehiclesConfig, specifically the fact that there is no wheel spin.
        /// </summary>
        [HideInInspector]
        public bool trackedVehicle = false;

        /// <summary>
        /// Only for tracked vehiclesConfig that use NVP wheel enlargement.
        ...
        /// Intended to be used with multiplayer for client vehiclesConfig.
        /// </summary>
        ...
        private void FrictionUpdate()
        {
            ...
            // No wheel spin for tracked vehiclesConfig
            if (trackedVehicle)
                wheel.angularVelocity = wheel.freeRollingAngularVelocity;
            ...
            // Limit side and forward force if needed, useful for drift vehiclesConfig in arcade games
