...
namespace NWH.VehiclePhysics 
{
	...
	public class Axle
	{
        ...
        public class Geometry
        {
            ...
            [Tooltip("Positive toe angle means that the wheels will face inwards (front of the wheel angled toward longitudinal center of the vehicleTransform).")]
            [Range(-8f, 8f)]
            [ShowInTelemetry, ShowInSettings(-8f, 8f, 0.5f)]
            public float toeAngle = 0;

            [Tooltip("Positive caster means that whe wheel will be angled towards the front of the vehicleTransform while negative " +
            ...
            [Tooltip("Used to reduce roll in the vehicleTransform. Should not exceed max spring force setting. Another way to reduce roll is to" +
        ...
        /// Not used with tracked vehiclesConfig.
        /// </summary>
