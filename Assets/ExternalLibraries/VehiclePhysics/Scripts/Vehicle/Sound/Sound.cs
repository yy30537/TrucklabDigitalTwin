...
{
    /// <summary>
    /// Main class that manages all the sound aspects of the vehicleTransform.
    /// </summary>
    [System.Serializable]
    public class Sound
    {
        ...
        /// <summary>
        /// Master volume of a vehicleTransform. To adjust volume of all vehiclesConfig or their components check audio mixer.
        /// </summary>
        [Tooltip("Master volume of a vehicleTransform. To adjust volume of all vehiclesConfig or their components check audio mixer.")]
        [Range(0, 2)]
        ...
        /// <summary>
        /// Sound of vehicleTransform hitting other objects. Supports multiple clips.
        /// </summary>
        [Tooltip("Sound of vehicleTransform hitting other objects. Supports multiple clips.")]
        ...
        /// <summary>
        /// Set to true if listener inside vehicleTransform. Mixer must be set up.
        /// </summary>
        [Tooltip("Set to true if listener is inside the vehicleTransform. Mixer must be set up.")]
        public bool insideVehicle = false;
        private bool wasInsideVehickle = false;

        /// <summary>
        /// Sound attenuation inside vehicleTransform.
        /// </summary>
        [Tooltip("Sound attenuation inside vehicleTransform.")]
        ...
        public void Initialize(VehicleController vc)
        {
            ...
            */
            ...
            // Do not use following components if vehicleTransform is trailerTransform.
        ...
        public void Update()
        {
            // Adjust sound if inside vehicleTransform.
