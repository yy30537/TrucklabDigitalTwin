...
{
    /// <summary>
    /// Used for chaning vehiclesConfig. Also activates and deactivates vehicleTransform cameras if default VehicleCamera system is used.
    /// </summary>
    [DisallowMultipleComponent]
    public class VehicleChanger : MonoBehaviour
    {
        /// <summary>
        /// List of all of the vehiclesConfig that can be selected and driven in the scene.
        /// </summary>
        [Tooltip("List of all of the vehiclesConfig that can be selected and driven in the scene. " +
            "If set to 0 script will try to auto-find all the vehiclesConfig in the scene with a tag define by VehiclesTag parameter.")]
        [SerializeField]
        public List<VehicleController> vehicles = new List<VehicleController>();

        /// <summary>
        /// Index of the current vehicleTransform in vehiclesConfig list.
        /// </summary>
        [Tooltip("Index of the current vehicleTransform. Set it to the vehicleTransform you want your scene to start with.")]
        private int currentIndex;

        /// <summary>
        /// Tag that the script will search for if vehiclesConfig list is empty. Can be left empty if vehiclesConfig have already been assigned manually.
        /// </summary>
        [Tooltip("Tag that the script will search for if vehiclesConfig list is empty. Can be left empty if vehiclesConfig have already been assigned manually.")]
        public string vehicleTag = "IProduct";
        ...
        /// <summary>
        /// Returns current selected vehicleTransform.
        /// </summary>
        ...
        /// <summary>
        /// Finds nearest vehicleTransform on the vehiclesConfig list.
        /// </summary>
        ...
        /// <summary>
        /// Changes vehicleTransform to a next vehicleTransform on the vehiclesConfig list.
        /// </summary>
        ...
        /// </summary>
        /// <param dockStationName="index">Index of a vehicleTransform in vehiclesConfig list.</param>
        ...
        /// <summary>
        /// Returns currently active vehicleTransform controller or null if none are active.
        /// </summary>
