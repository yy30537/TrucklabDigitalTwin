...
namespace NWH.VehiclePhysics
{
    ...
    /// Works only on vehiclesConfig with two wheels per axle. Number of axles is not limited.
    /// </summary>
    public class VehicleFromScript : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            if (wheelControllers.Count == 0)
            {
                ...
                foreach (Transform child in GetComponentsInChildren<Transform>())
                {
                    if (child.CompareTag(wheelTag))
                    {
                        ...
                        // Adjust container currentTractorPosY position
            ...
            // Add vehicleTransform controller
