...
namespace NWH.VehiclePhysics
{
    ...
    /// CollisionController sounds are handled by CrashComponent class.
    /// </summary>
    [System.Serializable]
    public class DamageHandler
    {
        /// <summary>
        /// Contains data on the collisionController that has last happened.
        /// </summary>
        public class CollisionEvent
        {
            ...
            /// <summary>
            /// CollisionController data for the collisionController event.
            /// </summary>
        ...
        /// <summary>
        /// Determines how much vertices will be deformed for given collisionController strength.
        /// </summary>
        [Tooltip("Determines how much vertices will be deformed for given collisionController strength.")]
        [Range(0.1f, 5f)]
        ...
        /// CollisionController state will be changed but no processing will happen.
        /// </summary>
        [Tooltip("Collisions with the objects that have a tag that is on this list will be ignored.")]
        public List<string> ignoreTags = new List<string>();

        /// <summary>
        /// Hash of the previous queued collisionController. Prevents reacting to the same collisionController twice since collisionController is called during OnCollisionStay() so more data can be collected.
        /// </summary>        
        [HideInInspector]
        ...
        /// <summary>
        /// Add collisionController to the queue of collisions waiting to be processed.
        /// </summary>
        public void Enqueue(Collision collision, float accelerationMagnitude)
        {
            ...
            foreach(MeshFilter deformableMeshFilter in deformableMeshFilters)
            {
                ...
                // Check if mesh is near collisionController point
        ...
        /// <summary>
        /// Deforms a mesh using data from collisionController event.
        /// </summary>
        public void MeshDeform(CollisionEvent collisionEvent, MeshFilter deformableMeshFilter)
        {
            ...
            //Vector3 direction = AverageCollisionNormal(collisionEvent.collisionController.contacts);
        ...
        /// <summary>
        /// Calculates average collisionController point from a list of contact points.
        /// </summary>
        ...
        /// <summary>
        /// Calculates average collisionController normal from a list of contact points.
        /// </summary>
