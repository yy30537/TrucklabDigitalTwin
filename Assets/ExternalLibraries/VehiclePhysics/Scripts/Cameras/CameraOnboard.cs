...
namespace NWH.VehiclePhysics
{
    ...
    {
        /// <summary>
        /// IProduct Controller that this script is targeting. Can be left empty if head movement is not being used.
        /// </summary>
        [Tooltip("IProduct Controller that this script is targeting. Can be left empty if head movement is not being used.")]
